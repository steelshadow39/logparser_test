...
input_dir = input_dir + '/logs/Linux/' # The input directory of log file
...
benchmark_settings = {
    ...
    'Linux': {
        ...
        # 'log_file': 'Linux_attack.log',
        # 'log_file': 'Linux.log',
        'log_format': '<Month>  <Day> <H>:<M>:<S> <Level> <Category>: <Content>',
...
for dataset, setting in benchmark_settings.items():
    ...
    F1_measure, accuracy = evaluator.evaluate(
                           groundtruth=os.path.join(indir, log_file + '_structured_attack.csv'),
                           parsedresult=os.path.join(output_dir, log_file + '_structured_attack.csv')
                           )
