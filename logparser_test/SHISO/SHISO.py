...
class LogParser:
    ...
    def outputResult(self, node):
        ...
        self.df_log.to_csv(os.path.join(self.savePath, self.logname + '_structured_NEW.csv'), index=False)
        df_event.to_csv(os.path.join(self.savePath, self.logname + '_templates_NEW.csv'), index=False)
        ...
        with open(log_file,'rb') as fin:
            for line in fin.readlines():
                try:
                    ...
                    # else: log_messages.append(message)
